const hiddenColumns = document.querySelectorAll(
  '.tariff-page_column._column-hidden',
);
const contestsColumns = document.querySelectorAll(
  '.tariff-page_column._column-contests',
);
const hiddenItems = document.querySelectorAll('.tariff-page_item._item-hidden');
const orderTitles = document.querySelectorAll(
  '.tariff-page_title._title-order',
);
const orderPrices = document.querySelectorAll(
  '.tariff-page_price._price-order',
);
const orderBodes = document.querySelectorAll('.tariff-page_body._body-order');
const orderFooters = document.querySelectorAll(
  '.tariff-page_footer._footer-order',
);
const orderDescriptions = document.querySelectorAll(
  '.tariff-page_description._description-order',
);
const hiddenTitle = document.querySelector('.tariff-page_title._title-hidden');
const hiddenDescription = document.querySelector(
  '.tariff-page_description._description-hidden',
);
const firstColumn = document.querySelector('.tariff-page_column._first-column');
const secondColumn = document.querySelector(
  '.tariff-page_column._second-column',
);

const tariffForm = document.querySelector('.tariff-page');
